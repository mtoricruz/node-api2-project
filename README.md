...
| ------ | ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| POST(DONE)| /api/posts              | Creates a post using the information sent inside the `request body`.                                                                                                        |
| POST (DONE)| /api/posts/:id/comments | Creates a comment for the post with the specified id using information sent inside of the `request body`.                                                                   |
| GET (DONE)| /api/posts              | Returns an array of all the post objects contained in the database.                                                                                                         |
| GET (DONE)| /api/posts/:id          | Returns the post object with the specified id.                                                                                                                              |
| GET (DONE)| /api/posts/:id/comments | Returns an array of all the comment objects associated with the post with the specified id.                                                                                 |
| DELETE (DONE) | /api/posts/:id          | Removes the post with the specified id and returns the **deleted post object**. You may need to make additional calls to the database in order to satisfy this requirement. |
